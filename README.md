...
* http://jbbcode.com is tweaked at https://github.com/hexbatch/jBBCode/tree/hex-batch-changes
* generate a diff as patch file and put that as a new patch in vendor-patches
* when upstream updates, then rebase hexbatch branch and redo patch
* The changes here allow for exposing the root, and keeping guid attributs on bb code for all elements, if they exist
...
### SCEditor changes for this project

Forked version is at https://github.com/hexbatch/SCEditor/tree/guids-as-optional-attributes-in-bbcode-and-html 

This allows guids to be put into the tags and html, and the editor will convert back and forth;
this allows remembering of older nodes and let some other neat stuff happen too, like linking and dragging and dropping

uses the public/resources/js/sceditor/minified/formats/bbcode.js generated by `grunt build` on the repo branch
https://github.com/hexbatch/SCEditor/tree/guids-as-optional-attributes-in-bbcode-and-html
